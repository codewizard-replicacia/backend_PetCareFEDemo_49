...
class ControllerTest {
  ...
  void  testRetrieveMetadataDocument() {
    ...
    assertNotNull(n);
    assertEquals("PetCareFEDemo", n.getAttribute("Namespace"));
  ...
  void  testCreatePetServiceInstance() throws IOException {
    given()
        ...
        .when()
        .post("/PetCareFEDemo/PetServices")
        .then()
  ...
  given()
   ...
   given()
            .when()
            .get("/PetCareFEDemo/PetServices?$top=1")
            .then()
    ...
    given()
            .when()
            .get("/PetCareFEDemo/PetServices/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  given()
   ...
   given()
            .when()
            .get("/PetCareFEDemo/PetOwners?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/PetCareFEDemo/PetOwners/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  void  testCreatePetCareCenterInstance() throws IOException {
    given()
        ...
        .when()
        .post("/PetCareFEDemo/PetCareCenters")
        .then()
        .statusCode(HttpStatusCode.CREATED.getStatusCode());
  ...
  given()
   ...
   given()
            .when()
            .get("/PetCareFEDemo/PetCareCenters?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/PetCareFEDemo/PetCareCenters/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  given()
   ...
   given()
            .when()
            .get("/PetCareFEDemo/Documents?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/PetCareFEDemo/Documents/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
